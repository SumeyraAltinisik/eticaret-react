  ...
  useEffect(() => {
    ...
    const getAllCustomerInfo = async () => {
        let response = await axios.get(
            'https://private-0cadd3-musteri.apiary-mock.com/urunkategorisi'
            );
    
            console.log("getAllCustomerInfo" + response.data.UrunKategorisiListesi);

            setAllCustomers(response.data.UrunKategorisiListesi);
