  ...
  useEffect(() => {
    ...
    const getAllCustomerInfo = async () => {
        let response = await axios.get(
            'https://private-0cadd3-musteri.apiary-mock.com/tahsilattipi'
            );
    
            console.log("getAllCustomerInfo" + response.data.TahsilatTipiListesi);

            setAllCustomers(response.data.TahsilatTipiListesi);
