  ...
  useEffect(() => {
    ...
    const getAllCustomerInfo = async () => {
        let response = await axios.get(
            'https://private-0cadd3-musteri.apiary-mock.com/tahsilat'
            );
    
            console.log("getAllCustomerInfo" + response.data.TahsilatListesi);

            setAllCustomers(response.data.TahsilatListesi);
