  ...
  useEffect(() => {
    ...
    const getAllCustomerInfo = async () => {
        let response = await axios.get(
            'https://private-0cadd3-musteri.apiary-mock.com/siparisdurumu'
            );
    
            console.log("getAllCustomerInfo" + response.data.SiparisDurumuListesi);

            setAllCustomers(response.data.SiparisDurumuListesi);
